...
- For error handling: always return errors rather than logging warnings for invalid/malformed data. Do not silently swallow errors or reset values to defaults on failure without explicit approval.
