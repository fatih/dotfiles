...
tap_dance_action_t tap_dance_actions[] = {
    ...
    // Tap once for Mute twice for Mac lock
    [TD_LOCK] = ACTION_TAP_DANCE_DOUBLE(KC_MUTE, MACLOCK),
};
...
[0] = LAYOUT_65_ansi_blocker( /* Base */
    ...
    LSG(KC_3)    , KC_LALT , KC_LGUI,                             LT(1, KC_SPC),              KC_RGUI , KC_RALT    ,                  KC_LEFT , KC_DOWN, KC_RGHT
),
