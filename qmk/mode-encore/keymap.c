...
// browser shortcuts
#define BS_SRCH LGUI(KC_F)
#define BS_NWTB LGUI(KC_T)
#define BS_CLTB LGUI(KC_W)
#define BS_NETB LAG(KC_RIGHT)
#define BS_PRTB LAG(KC_LEFT)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
[0] = LAYOUT_65_ansi_blocker( /* Base */
    KC_TILDE     , KC_1   , KC_2   , KC_3   , KC_4  , KC_5    , KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , KC_MINS      , KC_EQL , KC_BSPC, KC_MUTE ,
