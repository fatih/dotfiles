 ...
 */
    [_QWERTY] = LAYOUT_split_3x6_5_hlc(
     ...
     KC_LCTL , LSFT_T(KC_A) ,  KC_S   ,  KC_D  ,   LT(_NUMPAD, KC_F) ,   LT(_SYMBOLS, KC_G),                           KC_H,   LT(_NUMPAD, KC_J) ,  KC_K ,   KC_L ,RSFT_T(KC_SCLN),CTL_QUOT,
     KC_LSFT , KC_Z ,  KC_X   ,  KC_C  ,   KC_V ,   KC_B , OSM(MOD_LSFT),  HYPR(KC_5),     KC_ESC  , OSM(MOD_RSFT), KC_N,   KC_M ,KC_COMM, KC_DOT ,KC_SLSH, KC_RSFT,
                                KC_LEFT , KC_RIGHT, KC_LGUI, KC_BSPC , KC_TAB,     KC_RALT    , KC_ENT , LT(_SYMBOLS, KC_SPC), KC_UP, KC_DOWN,
